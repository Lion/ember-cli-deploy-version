    ...
    var DeployPlugin = DeployPluginBase.extend({
      ...
      */
      ...
      config: function (context) {
        ["versionCommit", "pushVersion"].forEach(
          this.applyDefaultConfigProperty.bind(this)
        );
      },
      //end of configs
      ...
      willDeploy: function (context) {
        ...
        if (versionNum) {
          if (versionCommit) {
            if (commitMessage) {
              // if there is a custom commit message
          ...
          //end of if(versionCommit)
            ...
            this.log("NOTICE: Changing version without committing", {
              color: "yellow",
            });
            return version.setVersionNoCommit(versionNum);
          }
          this.log(
            "calling npm version with the following param:" + versionNum
          );
        }
      ...
      upload: function (context) {
        ...
        if (doPush) {
          ...
          this.log(
            "GIT TAG is NOT pushed - make sure to manually check and update the tags so that they are consistent.",
            { color: "yellow" }
          );
        }
      },
